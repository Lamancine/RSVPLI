...
(function () {
  ...
  const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbzftpcPDz7fQAxguc225aslegll-nUdmU9qX1ljL745nBnUskkGJ9O6HLmxQcfah9G5/exec";
  ...
  function buildGuestPayload(rawData) {
    return {
      ...
      email:              rawData.email               || "",
      shuttleSKG:         rawData.Shuttle_SKG         || "",
      shuttleSKGDirection:rawData.Shuttle_SKG_direction || "",
