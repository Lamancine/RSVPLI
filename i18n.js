...
const pageTranslations = {
  en: {
    ...
    venue_cocktail_time: "Vin d'honneur: 6:00 PM",
    ...
    venue_shuttle: "🚌 Shuttle Service",
    venue_shuttle_desc: "We are planning a shuttle service (return) from Peraia to Ktima Xristidi. If you're interested, please select the option in the RSVP form.",
  ...
  fr: {
    ...
    venue_cocktail_time: "Vin d'honneur : 18h00",
    ...
    venue_shuttle: "🚌 Navette",
    venue_shuttle_desc: "Nous prévoyons une navette aller-retour de Peraia vers Ktima Xristidi. Si vous êtes intéressé, sélectionnez l'option dans le formulaire RSVP.",
  ...
  el: {
    ...
    venue_cocktail_time: "Vin d'honneur: 18:00",
    ...
    venue_shuttle: "🚌 Σέρβις Μεταφοράς",
    venue_shuttle_desc: "Σχεδιάζουμε σέρβις μεταφοράς (μετ' επιστροφής) από την Περαία προς το Ktima Xristidi. Αν ενδιαφέρεστε, επιλέξτε την αντίστοιχη επιλογή στη φόρμα RSVP.",
